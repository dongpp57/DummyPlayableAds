...
async function startGame() {
  ...
  function onDiscardTap() {
    ...
    unlockAudio();
    playBgm('bgm', 0.8); // start background music on first interaction
  ...
  function triggerKnock() {
    ...
    // +3 seconds after knock banner → stop BGM + open store (CTA)
    setTimeout(() => { stopBgm(); openUrl(STORE_URL); }, 3600);
  }
